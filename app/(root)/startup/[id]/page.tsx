...
const page = async ({ params }: { params: Promise<{ id: string }> }) => {
  ...
  const parsedContent = md.render(post?.pitch || ''); // used to parse markdown content to show as HTML
    ...
    <>
      ...
      <section className="section_container">
        ...
        <Suspense fallback={<Skeleton className="view_skeleton"/>}> 
            <View id={id}/>
        </Suspense> {/* this whole page is an example of the ppr as all of this page's content is static content but this no of views is the dynamic content of this page and this needs to be updated with time. */}
      </section>
    </>
  );
};
